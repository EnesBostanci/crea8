...
import { GridPattern } from "@/components/Template/GridPattern";
      ...
      <div className="flex items-center justify-between">
        ...
        >
          <Image
            ...
            alt="mainLogo"
            src={
              expanded ? "cre8Logos/whiteLogo.svg" : "cre8Logos/blackLogo.svg"
            }
          />
        </Link>
        <div className="flex items-center gap-x-8">
          <button
            ...
            className={clsx(
              ...
              invert ? "hover:bg-primary-900" : "hover:bg-primary-900"
            )}
    ...
    >
      ...
      >
        ...
        >
          {grid && (
            <GridPattern
              className="absolute inset-x-0 -top-14 -z-10 h-[1000px] w-full mask-[linear-gradient(to_bottom_left,white_40%,transparent_50%)] fill-black stroke-neutral-950/"
              yOffset={-96}
            />
          )}
